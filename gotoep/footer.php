		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						<br>
						Copyrights &copy; 2024 All Rights Reserved by ayush<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> ayushsd47@gmail.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> +91-6260145236  <span class="middot"></span>
					</div>
