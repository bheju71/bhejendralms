...
<?php
    ...
    if(isset($_POST['submit'])){        
        ...
        if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
            ...
            $to = "ayushsd47@gmail.com"; //Programmers email
            ...
            $header  = "ayushsd47@gmail.com";
            $subject = "Thank You $name";
            $message = "We are here for achieve your expectations. \nThank you for your FEEDBACK Form RECeducation point\n CEO EP";
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Email Address"><strong>Email:</strong></abbr> ayushsd@gmail.com
						...
						<div class="widget noborder notoppadding">
							...
							<a target="_blank" href="https://plus.google.com" class="social-icon si-small si-dark si-gplus">
								<i class="icon-gplus"></i>
								<i class="icon-gplus"></i>
							</a>

							<a target="_blank" href="https://www.dropbox.com" class="social-icon si-small si-dark si-dropbox">
								<i class="icon-dropbox2"></i>
								<i class="icon-dropbox2"></i>
							</a>

							<a target="_blank" href="https://github.com" class="social-icon si-small si-dark si-github">
